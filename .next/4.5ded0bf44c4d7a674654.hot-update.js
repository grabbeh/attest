...
var Chart = function (_React$Component) {
  ...
  _createClass(Chart, [{
    ...
    value: function render() {
      ...
      var d = __WEBPACK_IMPORTED_MODULE_3_lodash___default.a.groupBy(this.props.data.contracts, 'currentStatus.name');
      var data = __WEBPACK_IMPORTED_MODULE_3_lodash___default.a.values(d).map(function (value, index) {
        return {
      ...
      var val = __WEBPACK_IMPORTED_MODULE_3_lodash___default.a.values(d).map(function (value, index) {
        return {
          x: index,
          y: value.length
        };
      ...
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4__styles_Title__["a" /* default */], { text: 'Charts', __source: {
            fileName: _jsxFileName,
            lineNumber: 37
          }
        }),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          ...
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_react_vis__["b" /* VerticalBarSeries */], { data: data, __source: {
              fileName: _jsxFileName,
              lineNumber: 49
            }
          })
...
//# sourceMappingURL=4.5ded0bf44c4d7a674654.hot-update.js.map